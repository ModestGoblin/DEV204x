...
namespace ModuleSixAssignment.Classes
{
...
Student student1 = new Student("Kristen", "Mami", DateTime.Now, string.Empty, string.Empty, string.Empty,
string.Empty, string.Empty, string.Empty, string.Empty);
Student student2 = new Student("Devon", "Soup", DateTime.Now, string.Empty, string.Empty, string.Empty,
string.Empty, string.Empty, string.Empty, string.Empty);
Student student3 = new Student("Miley", "Balloon", DateTime.Now, string.Empty, string.Empty, string.Empty,
string.Empty, string.Empty, string.Empty, string.Empty);

/*Using some empty values for simplicity shake*/
Teacher teacher = new Teacher("Dr.", "Emil", "South", DateTime.Now, string.Empty, string.Empty, string.Empty,
